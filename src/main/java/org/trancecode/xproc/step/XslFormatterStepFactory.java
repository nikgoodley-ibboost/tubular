 ...
 * @version $Revision$
 */
public class XslFormatterStepFactory extends AbstractStepFactory
{
	...
	public static final XslFormatterStepFactory INSTANCE = new XslFormatterStepFactory();


	public XslFormatterStepFactory()
	{
		super(XProcSteps.XSL_FORMATTER, null, false, PORTS, VARIABLES);
	}
}
