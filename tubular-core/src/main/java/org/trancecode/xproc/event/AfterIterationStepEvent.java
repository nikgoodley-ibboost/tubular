 ...
 * @author Herve Quiroz
 */
public final class AfterIterationStepEvent extends AbstractStepEvent
{
    ...
    public AfterIterationStepEvent(final Pipeline pipeline, final Step step, final Environment sourceEnvironment,
            final Environment resultEnvironment, final int iterationPosition, final int iterationSize)
    {
        super(pipeline, step);
