...
public interface XProcSteps extends XProcNamespaces
{
    ...
    Set<QName> REQUIRED_STEPS = ImmutableSet.of(ADD_ATTRIBUTE, ADD_XML_BASE, COMPARE, COUNT, DELETE, DIRECTORY_LIST,
            ERROR, ESCAPE_MARKUP, FILTER, HTTP_REQUEST, IDENTITY, INSERT, LABEL_ELEMENT, LOAD, MAKE_ABSOLUTE_URIS,
            NAMESPACE_RENAME, PACK, PARAMETERS, RENAME, REPLACE, SET_ATTRIBUTES, SINK, SPLIT_SEQUENCE, STORE,
            STRING_REPLACE, UNESCAPE_MARKUP, UNWRAP, WRAP, XINCLUDE, XSLT);
    ...
    Set<QName> OPTIONAL_STEPS = ImmutableSet.of(EXEC, HASH, UUID, VALIDATE_WITH_RELANXNG, VALIDATE_WITH_SCHEMA,
            VALIDATE_WITH_SCHEMATRON, WWW_FORM_URL_DECODE, WWW_FORM_URL_ENCODE, XQUERY, XSL_FORMATTER);
